...
if (isset($_POST["submit"])) {
  ...
  if ($pictureArray->error === 0) {
      ($_POST["picture"] == "smile.jpg") ?: unlink("pictures/{$_POST["picture"]}");
      $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name', email = '$email', address = '$address', phone_number = '$phone_number', picture = '$pictureArray->fileName' WHERE id = {$id}";
    } else {
      $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name', email = '$email', address = '$address', phone_number = '$phone_number', WHERE userID = {$id}";
  }
  ...
  <div class="container">
      ...
      <form method="post" enctype="multipart/form-data">
          <table class="table">
              ...
              <tr>
                  <th>Phone Number</th>
                  <td><input class="form-control" type="text" name="phone_number" placeholder="PhoneNumber" value="<?php echo $phone_number ?>"
                  /></td>
              </tr>
              <tr>
                  <th>Picture</th>
