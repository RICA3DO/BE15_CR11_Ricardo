...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
        $tbody .= "<tr>
            ...
            <a href='delete.php?id=" . $row['userID'] . "'><button class='btn btn-danger btn-lg' title='Delete User' type='button'> Delete <i class='fas fa-user-minus'></i></button></a></td>
         </tr>";
    }
} else {
...
<div class="container d-flex justify-content-center">
    <div class="row">
        <img class="userImage img-thumbnail rounded-circle" src="pictures/chad.jpg" alt="chad">
        <h1 class="">Admin</h1> 
        <div class="mt-5">
